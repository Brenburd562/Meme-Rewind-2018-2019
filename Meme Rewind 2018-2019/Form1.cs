        ...
        private void Form1_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            switch (scene)
            {
                ...
                case 10:
                    ...
                    break;
                case 11:
                    outputMain.Text = "She takes you back to her house where she give you some cinnamon, butterscotch cake.";
                ...
                case 22:
                    outputMain.Text = "once in the base you explore finding what a appears to be cookie monster. he has a gun and forces you through" +
                        " a near by portal \"You Shall be sacrificed to the great Deckard! NOM NOM NOM!\" he says as you enter the portal.";
                    buttBlue.Text = "";
                    buttRed.Text = "";
                    buttYell.Text = "";
                    break;
                ...
                case 32:
                    outputMain.Text = "you question the wizard \"endgame?\" you ask. the wizard nods and suddenly portals begin to open behind you. tons of" +
                        ...
                        "Area 51 attack force now loaded with there high tech alien weaponry.";
                    buttBlue.Text = "";
                    buttRed.Text = "";
                    buttYell.Text = "";
                    break;
                case 33:
                    outputMain.Text = "you pick the holy sword and then proceed to charge the dragon. as the dragon raises its foot you quickly relize maybe " +
                        "the sword wasnt a good choice. the dragon stops on you and your small sword.";
                    buttBlue.Text = "";
                    buttRed.Text = "";
                    buttYell.Text = "";
                    break;
